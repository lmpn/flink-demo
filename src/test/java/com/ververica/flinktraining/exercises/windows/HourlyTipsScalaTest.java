...
package com.ververica.flinktraining.exercises.windows;
...
public class HourlyTipsScalaTest extends HourlyTipsTest {
	...
	static TaxiRideTestBase.Testable scalaExercise = () -> HourlyTipsExercise.main(new String[]{});

	protected List<Tuple3<Long, Long, Float>> results(TaxiRideTestBase.TestFareSource source) throws Exception {
		TaxiRideTestBase.Testable scalaSolution = () -> com.ververica.flinktraining.solutions.datastream_scala.windows.HourlyTipsSolution.main(new String[]{});
		List<?> tuples = runApp(source, new TaxiRideTestBase.TestSink<>(), scalaExercise, scalaSolution);
