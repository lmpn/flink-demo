...
import com.ververica.flinktraining.use_cases.process.LongRidesSolution;
import com.google.common.collect.Lists;
import com.ververica.flinktraining.use_cases.process.CheckpointedLongRidesSolution;
...
public class LongRidesTest extends TaxiRideTestBase<TaxiRide> {
	...
	protected List<TaxiRide> cepResults(TestRideSource source) throws Exception {
		Testable javaCEPSolution = () -> com.ververica.flinktraining.use_cases.cep.LongRidesSolution.main(new String[]{});
	...
	protected List<TaxiRide> checkpointedResults(TestRideSource source) throws Exception {
		Testable checkpointedSolution = () -> CheckpointedLongRidesSolution.main(new String[]{});
